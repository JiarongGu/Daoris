...
| [repository-owns-its-work](repository-owns-its-work.md) | a change you need lives in a different repository, or you are tempted to edit one from here | work happens in the repository that owns it; a change you need elsewhere is a request in that repository's backlog, never an edit made from outside |
