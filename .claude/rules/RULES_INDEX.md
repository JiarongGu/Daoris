...
| [model-is-optional](../knowledge/model-is-optional.md) | building any feature that uses a language model, an embedding model, or any AI service | specify the feature without naming a model; select the provider by deployment; report which tier ran |
